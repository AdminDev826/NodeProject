function processDataVk(data) {
    ...
    marker.meta.posted_image    = posted_image;
    marker.meta.posted_time     = posted_time;
    marker.meta.typ             = dmn;
    marker.meta.user_url        = user_url;
    marker.meta.sentiment       = sentiment;
    marker.meta.content         = getContentVk(dmn, profile_picture, link, fullname, username, posted_time, sentiment, description, posted_image);
    
    google.maps.event.addListener(marker, "mouseover", function(){
        showMarkerTooltip(marker);
    });
    addPostItemToList(getContentVk(dmn, profile_picture, link, fullname, username, posted_time, sentiment, description, posted_image));
}
