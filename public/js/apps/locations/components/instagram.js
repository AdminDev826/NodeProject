function processDataInstagram(data){
    var dmn = "INSTAGRAM";
    ...
    if (location_info) {
        ...
        marker.meta.content         = getContentInstagram(dmn, profile_picture, link, fullname, username, posted_time, sentiment, description, posted_image);
        
        google.maps.event.addListener(marker, "mouseover", function(){
            showMarkerTooltip(marker);
        });
        addPostItemToList(getContentInstagram(dmn, profile_picture, link, fullname, username, posted_time, sentiment, description, posted_image));
    }
}
