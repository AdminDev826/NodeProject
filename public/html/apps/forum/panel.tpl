<header class="slidePanel-header">
  <div class="slidePanel-actions" aria-label="actions" role="group">
    ...
    <div class="btn-group actions-bottom btn-group-flat" role="group">
      <button type="button" class="btn btn-pure btn-inverse icon md-chevron-left"></button>
      <button type="button" class="btn btn-pure btn-inverse icon md-chevron-right"></button>
    </div>
  </div>
  ...
  <section class="slidePanel-inner-section">
    ...
    <div class="forum-metas">
      ...
      <div class="button-group share">
        Share:
        <button type="button" class="btn btn-icon btn-pure btn-default"><i class="icon bd-twitter"></i></button>
        <button type="button" class="btn btn-icon btn-pure btn-default"><i class="icon bd-facebook"></i></button>
        <button type="button" class="btn btn-icon btn-pure btn-default"><i class="icon bd-dribbble"></i></button>
      </div>
    </div>
  </section>
  <section class="slidePanel-inner-section">
