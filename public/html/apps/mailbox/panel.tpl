    ...
    <div class="btn-group actions-bottom btn-group-flat" role="group">
      <div class="pull-xs-left" style="position:relative;">
        ...
        <div class="dropdown-menu dropdown-menu-right" role="menu">
          <a class="dropdown-item" href="javascript:void(0)"><i class="icon md-inbox"></i> Archive</a>
          <a class="dropdown-item" href="javascript:void(0)"><i class="icon md-alert-circle"></i> Report Spam</a>
          <a class="dropdown-item" href="javascript:void(0)"><i class="icon md-delete"></i> Delete</a>
          <a class="dropdown-item" href="javascript:void(0)"><i class="icon md-print"></i> Print</a>
        </div>
      </div>
    ...
    <div class="mail-header">
      <div class="mail-header-main">
        ...
        <div><a href="javascript:void(0)">Mazhesee@gmail.com</a> to <a href="javascript:void(0)">me</a>
          <span
            class="identity"><i class="md-circle font-size-10 red-600"></i>Work</span>
        </div>
      </div>
      <div class="mail-header-right">
        <span class="time">3 minutes ago</span>
        <div class="btn-group actions" role="group">
          <button type="button" class="btn btn-icon btn-pure btn-default"><i class="icon md-star"></i></button>
          <button type="button" class="btn btn-icon btn-pure btn-default"><i class="icon md-mail-reply"></i></button>
        </div>
      </div>
    </div>
    ...
    <div class="mail-attachments">
      ...
      <ul class="list-group">
        <li class="list-group-item">
          ...
          <button type="button" class="btn btn-icon btn-pure btn-default"><i class="icon md-download"></i></button>
        </li>
        <li class="list-group-item">
