    ...
    <div class="slidePanel-actions btn-group btn-group-flat" aria-label="actions" role="group">
      ...
      <div class="dropdown pull-xs-left">
        ...
        <div class="dropdown-menu dropdown-menu-right bullet" role="menu">
          <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon md-edit"></i>Edit Task</a>
          <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon md-delete"></i>Delete Task</a>
        </div>
      </div>
      <button type="button" class="btn btn-pure slidePanel-close icon md-close"></button>
    </div>
