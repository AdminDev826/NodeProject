  ...
  <div class="overlay-panel overlay-background vertical-align">
    <div class="slidePanel-actions">
      <div class="btn-group btn-group-flat">
        <button type="button" class="btn btn-pure btn-inverse icon md-folder"></button>
        <button type="button" class="btn btn-pure btn-inverse icon md-delete"></button>
    ...
    <button type="button" class="edit btn btn-success btn-floating" data-toggle="edit">
      <i class="icon md-edit animation-scale-up"></i>
      <i class="icon md-close animation-scale-up"></i>
    </button>
  </div>
</header>
