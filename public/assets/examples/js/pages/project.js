...
(function(document, window, $) {
  ...
  $('#projectUploadForm').fileupload({
    ...
    uploadTemplate: tmpl(
      ...
      '<i class="icon md-upload start" data-toggle="tooltip" data-original-title="Upload file"></i>' +
      '{% } %}' +
      '{% if (!i) { %}' +
      '<i class="icon md-close cancel" data-toggle="tooltip" data-original-title="Stop upload file"></i>' +
      '{% } %}' +
      '</div>' +
      '</div>' +
      '</div>' +
    ...
    downloadTemplate: tmpl(
      ...
      '<div class="file-action-wrap">' +
      '<div class="file-action">' +
      '<i class="icon md-delete delete" data-toggle="tooltip" data-original-title="Delete files"></i>' +
      '</div>' +
      '</div>' +
      '<img src="{%=file.url%}"/>' +
      '</div>' +
